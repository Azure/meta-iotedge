...
SRCREV = "0e45ed930f9659bbca757c0f3aea00aedc1e358f"
S = "${WORKDIR}/git"
...
EXTRA_OECARGO_PATHS += "${WORKDIR}/aziot-cert-client-async/cert/aziot-cert-client-async"
SRCREV_FORMAT .= "_aziot-cert-common-http"
SRCREV_aziot-cert-common-http = "main"
EXTRA_OECARGO_PATHS += "${WORKDIR}/aziot-cert-common-http/cert/aziot-cert-common-http"
SRCREV_FORMAT .= "_aziot-certd-config"
SRCREV_aziot-certd-config = "main"
EXTRA_OECARGO_PATHS += "${WORKDIR}/aziot-certd-config/cert/aziot-certd-config"
SRCREV_FORMAT .= "_aziot-identity-client-async"
SRCREV_aziot-identity-client-async = "main"
EXTRA_OECARGO_PATHS += "${WORKDIR}/aziot-identity-client-async/identity/aziot-identity-client-async"
SRCREV_FORMAT .= "_aziot-identity-common"
SRCREV_aziot-identity-common = "main"
EXTRA_OECARGO_PATHS += "${WORKDIR}/aziot-identity-common/identity/aziot-identity-common"
SRCREV_FORMAT .= "_aziot-identity-common-http"
SRCREV_aziot-identity-common-http = "main"
EXTRA_OECARGO_PATHS += "${WORKDIR}/aziot-identity-common-http/identity/aziot-identity-common-http"
SRCREV_FORMAT .= "_aziot-identityd-config"
SRCREV_aziot-identityd-config = "main"
EXTRA_OECARGO_PATHS += "${WORKDIR}/aziot-identityd-config/identity/aziot-identityd-config"
SRCREV_FORMAT .= "_aziot-key-client"
SRCREV_aziot-key-client = "main"
EXTRA_OECARGO_PATHS += "${WORKDIR}/aziot-key-client/key/aziot-key-client"
SRCREV_FORMAT .= "_aziot-key-client-async"
SRCREV_aziot-key-client-async = "main"
EXTRA_OECARGO_PATHS += "${WORKDIR}/aziot-key-client-async/key/aziot-key-client-async"
SRCREV_FORMAT .= "_aziot-key-common"
SRCREV_aziot-key-common = "main"
EXTRA_OECARGO_PATHS += "${WORKDIR}/aziot-key-common/key/aziot-key-common"
SRCREV_FORMAT .= "_aziot-key-common-http"
SRCREV_aziot-key-common-http = "main"
EXTRA_OECARGO_PATHS += "${WORKDIR}/aziot-key-common-http/key/aziot-key-common-http"
SRCREV_FORMAT .= "_aziot-key-openssl-engine"
SRCREV_aziot-key-openssl-engine = "main"
EXTRA_OECARGO_PATHS += "${WORKDIR}/aziot-key-openssl-engine/key/aziot-key-openssl-engine"
SRCREV_FORMAT .= "_aziot-keyd-config"
SRCREV_aziot-keyd-config = "main"
EXTRA_OECARGO_PATHS += "${WORKDIR}/aziot-keyd-config/key/aziot-keyd-config"
SRCREV_FORMAT .= "_aziot-keys-common"
SRCREV_aziot-keys-common = "main"
EXTRA_OECARGO_PATHS += "${WORKDIR}/aziot-keys-common/key/aziot-keys-common"
SRCREV_FORMAT .= "_aziot-tpmd-config"
SRCREV_aziot-tpmd-config = "main"
EXTRA_OECARGO_PATHS += "${WORKDIR}/aziot-tpmd-config/tpm/aziot-tpmd-config"
SRCREV_FORMAT .= "_aziotctl-common"
SRCREV_aziotctl-common = "main"
EXTRA_OECARGO_PATHS += "${WORKDIR}/aziotctl-common/aziotctl/aziotctl-common"
SRCREV_FORMAT .= "_cert-renewal"
SRCREV_cert-renewal = "main"
EXTRA_OECARGO_PATHS += "${WORKDIR}/cert-renewal/cert/cert-renewal"
SRCREV_FORMAT .= "_config-common"
SRCREV_config-common = "main"
EXTRA_OECARGO_PATHS += "${WORKDIR}/config-common/config-common"
SRCREV_FORMAT .= "_http-common"
SRCREV_http-common = "main"
EXTRA_OECARGO_PATHS += "${WORKDIR}/http-common/http-common"
SRCREV_FORMAT .= "_logger"
SRCREV_logger = "main"
EXTRA_OECARGO_PATHS += "${WORKDIR}/logger/logger"
SRCREV_FORMAT .= "_openssl-build"
SRCREV_openssl-build = "main"
EXTRA_OECARGO_PATHS += "${WORKDIR}/openssl-build/openssl-build"
SRCREV_FORMAT .= "_openssl-sys2"
SRCREV_openssl-sys2 = "main"
EXTRA_OECARGO_PATHS += "${WORKDIR}/openssl-sys2/openssl-sys2"
SRCREV_FORMAT .= "_openssl2"
SRCREV_openssl2 = "main"
EXTRA_OECARGO_PATHS += "${WORKDIR}/openssl2/openssl2"
SRCREV_FORMAT .= "_pkcs11"
SRCREV_pkcs11 = "main"
EXTRA_OECARGO_PATHS += "${WORKDIR}/pkcs11/pkcs11/pkcs11"
SRCREV_FORMAT .= "_pkcs11-sys"
SRCREV_pkcs11-sys = "main"
EXTRA_OECARGO_PATHS += "${WORKDIR}/pkcs11-sys/pkcs11/pkcs11-sys"
SRCREV_FORMAT .= "_test-common"
SRCREV_test-common = "main"
EXTRA_OECARGO_PATHS += "${WORKDIR}/test-common/test-common"
